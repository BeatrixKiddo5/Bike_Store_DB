...
class csv_to_db_loader:       
    ...
    def insert_into_db_tables(self):
        ...
        try:
            ...
            conn.close()
            logging.info(f"Closed connection to DataBase {s}")
        
        except Exception as e:
            raise CustomException(e, sys)

csv_to_db_loader().insert_into_db_tables()
